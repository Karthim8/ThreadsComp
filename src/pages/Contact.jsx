...
import { Mail, Phone, Linkedin, MapPin, Code2, Cpu, Zap, Globe } from 'lucide-react';
...
const TEAM_MEMBERS = [
    ...
    },
    {
        ...
        linkedin: "kreeshab" // Add actual LinkedIn username
    },
    {
        id: 5,
        name: "KAMALESH S",
            ...
            <div className="flip-card-inner transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)]">
                ...
                <div className="flip-card-front flex flex-col p-5 relative overflow-hidden rounded-[20px] border border-white/10 bg-[#0f172a] shadow-xl">
                    ...
                    <div className="w-full flex-grow flex items-center justify-center mb-2 mt-4 relative z-10">
                        <div className="w-42 h-42 md:w-40 md:h-36 rounded-full p-[3px] relative overflow-hidden bg-gradient-to-br from-neon-cyan/50 to-purple-600/50 group-hover:from-neon-cyan group-hover:to-purple-500 transition-all duration-500 shadow-2xl">
...
const TerminalBanner = ({ inView, onComplete }) => {
    ...
    useEffect(() => {
        ...
        fullText.forEach((line, lineIndex) => {
            // Calculate when this line should start appearing
            // We want it fast, so just a small stagger
            const currentLineDelay = line.delay;

            setTimeout(() => {
                setLines(prev => [...prev, line]);

                // If it's the last line, trigger complete very quickly
    ...
    return (
        ...
        >
            <div className="flex items-center gap-2 px-4 py-2 border-b border-neon-cyan/10 bg-black/30">
                <div className="flex gap-1.5 has-tooltip">
                    <span className="w-2.5 h-2.5 rounded-full bg-red-500/80 shadow-[0_0_8px_rgba(239,68,68,0.6)]"></span>
                    <span className="w-2.5 h-2.5 rounded-full bg-yellow-500/80 shadow-[0_0_8px_rgba(234,179,8,0.6)]"></span>
                    <span className="w-2.5 h-2.5 rounded-full bg-green-500/80 shadow-[0_0_8px_rgba(34,197,94,0.6)]"></span>
                </div>
                <span className="ml-3 text-neon-cyan/60 tracking-widest text-[10px] uppercase opacity-70">
                    threads26@root:~
                </span>
            </div>
...
const TypewriterLine = ({ text, color }) => {
    ...
    useEffect(() => {
        let i = 0;
        const speed = 15; // super fast typing speed (ms per char)
            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                >
                        ...
                        <address className="not-italic text-gray-400 space-y-6 text-lg font-mono">
                            ...
                            <div className="pt-4 border-t border-white/10">
                                <p className="flex items-center gap-3 text-white mb-2">
                                    ...
                                    <a href="mailto:t" className="hover:text-neon-cyan transition-colors">
                    ...
                    <div className="bg-[#090011]/50 min-h-[350px] relative filter grayscale contrast-125 hover:filter-none transition-all duration-500">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3907.643329938661!2d78.1182413148126!3d11.64835699173204!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3babf06f7b1b3b1b%3A0x6c6d05f0b0676b0!2sSona%20College%20of%20Technology!5e0!3m2!1sen!2sin!4v1645520868541!5m2!1sen!2sin"
