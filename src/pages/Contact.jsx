        ...
        <div className="pt-24 pb-20 min-h-screen bg-[#0b1120] text-white overflow-x-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mt-32 grid grid-cols-1 lg:grid-cols-2 gap-8 bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
                    ...
                    <div className="bg-[#090011]/50 min-h-[350px] relative"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3739.340757703201!2d78.12186387480286!3d11.678139141915262!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3babf065115b5f7d%3A0x1d08f4d05518b24d!2sSona%20College%20of%20Technology!5e1!3m2!1sen!2sin!4v1771744074113!5m2!1sen!2sin" width="100%" height="100%" style={{ border: 0 }} allowFullScreen="" loading="lazy"></iframe></div>
                </motion.div>
            </div>
        </div>
    );
