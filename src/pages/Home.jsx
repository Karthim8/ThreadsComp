                ...
                >
                    ...
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <div className="mt-8 flex flex-col items-center gap-3">
                            <p className="text-neon-green/90 text-xs sm:text-sm md:text-base font-orbitron uppercase tracking-[0.2em] font-black drop-shadow-[0_0_8px_rgba(0,255,157,0.3)]">
                                <span className="mr-2">🍴</span> LUNCH & REFRESHMENTS WILL BE PROVIDED
                            </p>
                            <p className="text-red-500/90 text-xs sm:text-sm md:text-base font-orbitron uppercase tracking-[0.2em] font-black drop-shadow-[0_0_8px_rgba(239,68,68,0.3)]">
                                <span className="mr-2">🏠</span> NO ACCOMMODATION PROVIDED
                            </p>
                        </div>
                    </div>
