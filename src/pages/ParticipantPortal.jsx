...
const ParticipantPortal = () => {
    ...
    const handleVerifyClick = async () => {
        ...
        if (!transactionId) {
            const { value: result } = await Swal.fire({
                ...
                text: 'Enter your UPI Transaction ID (UTR)',
                input: 'text',
        ...
        try {
            ...
            if (data.success || data.verified) {
                ...
                await Swal.fire({
                    ...
                    text: 'Your registration is now confirmed.',
                    timer: 2000,
    ...
    if (!profile && offlineCache) {
        ...
        const isVerified = (c.needs_payment === false) || (localStorage.getItem('threads26_verification_status') === 'VERIFIED');
        const displayQr = isVerified
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
                ...
                >
                    ...
                    <div className="flex items-center gap-2">
                        <span className={`px-3 py-0.5 rounded-full text-[10px] font-black tracking-widest uppercase ${profile.verification_status === 'VERIFIED' || localStorage.getItem('threads26_verification_status') === 'VERIFIED' ? 'bg-neon-green/10 text-neon-green border border-neon-green/30' : 'bg-yellow-500/10 text-yellow-500 border border-yellow-500/30'}`}>
                            {profile.verification_status === 'NOT_VERIFIED' && localStorage.getItem('threads26_verification_status') === 'VERIFIED' ? 'PENDING SYNC' : profile.verification_status}
                        </span>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-[#0f0f13] border border-white/10 rounded-3xl p-8 shadow-2xl relative overflow-hidden group">
                        ...
                        {profile.verification_status === 'ADMIN_VERIFIED' ||
                            ...
                            profile.payment_summary?.pending_registrations === 0 && profile.payment_summary?.paid_registrations > 0 ? (
                            <div className="text-center">
                                <h4 className="font-orbitron font-bold text-white mb-6 uppercase tracking-widest animate-pulse">Event Entry Pass</h4>
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-between items-center text-xs">
                                ...
                                <span className={profile.verification_status === 'VERIFIED' ? 'text-neon-green font-bold' : 'text-yellow-500 font-bold'}>
