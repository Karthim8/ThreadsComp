...
const SECTIONS = [
    ...
    },
    {
        ...
        content: [
            { type: 'rule', n: 1, text: 'Only Individual Participation is allowed.' },
            { type: 'rule', n: 2, text: 'The event consists of 2 Rounds : Round 1 (Gamified Aptitude) and Round 2 (1 vs 1).' },
            { type: 'round', round: 'Round 1 – Gamified Aptitude', duration: '20s/Q', details: '30 MCQs testing critical thinking. No negative marking. Top scorers advance to Round 2.' },
            { type: 'round', round: 'Round 2 – 1 vs 1', duration: 'Elimination', details: 'Focuses on Coding, Debugging, Fill the missing parts, and Optimization. HP system: Solve easy/medium/hard problems to reduce opponent HP.' },
            { type: 'subheading', text: 'Technical Rules' },
            { type: 'bullet', text: 'Allowed Programming Languages: Python, C, Java.' },
            { type: 'bullet', text: 'Only pen and paper are allowed for rough work.' },
            { type: 'bullet', text: 'Use of mobile phones, smart devices, internet, or external storage is strictly prohibited unless permitted.' },
            { type: 'bullet', text: 'Participants must use only the system/platform assigned by the organizers.' },
            { type: 'bullet', text: 'Any attempt to access unauthorized files/websites will result in immediate disqualification.' },
            { type: 'subheading', text: 'General Guidelines' },
            { type: 'bullet', text: 'Participants must report to the venue 30 minutes before the event begins.' },
            { type: 'bullet', text: 'Instructions provided before each round must be strictly followed.' },
            { type: 'bullet', text: 'Maintain discipline and professional conduct throughout the event.' },
            { type: 'subheading', text: 'Disqualification Criteria' },
            { type: 'bullet', text: 'Use of unfair means or unauthorized materials.' },
            { type: 'bullet', text: 'Disturbing other participants or failing to follow instructions.' },
            { type: 'rule', n: 8, text: 'All participants must carry a valid ID Card.' },
        ],
    },
    {
        id: 'nontech-header',
    ...
    },
    {
        ...
        tag: 'N-05',
        color: '#00FFA3',
        title: 'CRICNOMICS–THE AUCTION LEAGUE',
        subtitle: 'RULESANDREGULATIONS(By DEXTER’S CLUB)',
        organizers: ['Dharunkumar S', 'Dharshana R', 'Alrifa I', 'Rahul N S'],
        content: [
            { type: 'rule', n: 1, text: 'Each team must consist of 2 to 4 members.' },
            { type: 'rule', n: 2, text: 'The event consists of 2 rounds: Round 1 (IPL Auction) and Round 2 (Business Battle).' },
            { type: 'subheading', text: 'Round 1 – IPL AUCTION' },
            { type: 'para', text: 'Focus: Planning, Teamwork, Bidding Strategy.' },
            { type: 'bullet', text: 'Each team is given a fixed virtual budget to bid for players in real time.' },
            { type: 'bullet', text: 'Teams must consist of 11–15 players (min. 3 Batsmen, 3 Bowlers, 2 All-rounders, 1 WK).' },
            { type: 'bullet', text: 'Teams must utilize only 60–70% of their budget in Round 1.' },
            { type: 'bullet', text: 'Top 7–8 best teams qualify for Round 2.' },
            { type: 'subheading', text: 'Round 2 – Business Battle' },
            { type: 'para', text: 'Focus: Investments, Financial Planning, Risk Management.' },
            { type: 'bullet', text: 'Teams pick sponsors (Local, National, Global) which dictate retention.' },
            { type: 'bullet', text: 'Includes Match Day Event (Random Draw) and Remaining Purse Bonus.' },
            { type: 'rule', n: 5, text: 'The teams which build their Best Franchise will be the Winner.' },
            { type: 'subheading', text: 'General Rules' },
            { type: 'bullet', text: 'Investment choice cannot be changed once submitted.' },
            { type: 'bullet', text: 'Event cards are purely random; Judge’s decision is final.' },
            { type: 'bullet', text: 'Teams with any undisciplinary activities may lead to disqualification.' },
        ],
    },
];
